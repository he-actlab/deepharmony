...
from deepharmony.scalar.dtypes import Dtype, FQDtype, FixedPoint, Log, Binary, Float, CustomFloat
from deepharmony.utils.utils import lookup_pandas_dataframe
...
class Graph(object):
    ...
    def benchmark_tf(self, phase='forward+backward', csv_file='gpu_baseline.csv'):
        ...
        if len(r) == 0:
            ...
            from deepharmony.tf_utils import get_tf_performance
